...
public ref class vtkImageButterworthLowPass : public vtkThreadedImageAlgorithm
{

public:
// Did not wrap:  static vtkImageButterworthLowPass *New ();
  ...
  // vtkImageButterworthLowPass *NewInstance ();
  vtkImageButterworthLowPass^ NewInstance();


  // vtkImageButterworthLowPass *SafeDownCast (vtkObject* o);
  static vtkImageButterworthLowPass^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkImageButterworthLowPass ();
...
// Did not wrap:  vtkImageButterworthLowPass (const vtkImageButterworthLowPass &);


// Did not wrap:  void vtkImageButterworthLowPass 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkImageButterworthLowPass(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkImageButterworthLowPass(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkImageButterworthLowPass();
