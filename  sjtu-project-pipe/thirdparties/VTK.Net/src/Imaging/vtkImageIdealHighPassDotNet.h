...
public ref class vtkImageIdealHighPass : public vtkThreadedImageAlgorithm
{

public:
// Did not wrap:  static vtkImageIdealHighPass *New ();
  ...
  // vtkImageIdealHighPass *NewInstance ();
  vtkImageIdealHighPass^ NewInstance();


  // vtkImageIdealHighPass *SafeDownCast (vtkObject* o);
  static vtkImageIdealHighPass^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkImageIdealHighPass ();
...
// Did not wrap:  vtkImageIdealHighPass (const vtkImageIdealHighPass &);


// Did not wrap:  void vtkImageIdealHighPass 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkImageIdealHighPass(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkImageIdealHighPass(bool donothing);
