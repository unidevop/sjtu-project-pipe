...
public ref class vtkUnstructuredGridVolumeZSweepMapper : public vtkUnstructuredGridVolumeMapper
{
...
public:
  ...
  // vtkUnstructuredGridVolumeZSweepMapper *SafeDownCast (vtkObject* o);
  static vtkUnstructuredGridVolumeZSweepMapper^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  static vtkUnstructuredGridVolumeZSweepMapper *New ();
...
// Did not wrap:  vtkUnstructuredGridVolumeZSweepMapper ();


// Did not wrap:  ~vtkUnstructuredGridVolumeZSweepMapper ();


// Did not wrap:  void BuildUseSets ();


// Did not wrap:  void ReorderTriangle (vtkIdType v[3], vtkIdType w[3]);


// Did not wrap:  void ProjectAndSortVertices (vtkRenderer *ren, vtkVolume *vol);


// Did not wrap:  void CreateAndCleanPixelList ();


// Did not wrap:  void MainLoop (vtkRenderWindow *renWin);


// Did not wrap:  void CompositeFunction (double zTarget);


// Did not wrap:  unsigned char ColorComponentRealToByte (float color);


// Did not wrap:  void RasterizeFace (vtkIdType faceIds[3]);


// Did not wrap:  void RasterizeTriangle (vtkVertexEntry *ve0, vtkVertexEntry *ve1, vtkVertexEntry *ve2);


// Did not wrap:  void RasterizeSpan (int y, vtkScreenEdge *left, vtkScreenEdge *right);


// Did not wrap:  void RasterizeLine (vtkVertexEntry *v0, vtkVertexEntry *v1);
...
// Did not wrap:  void AllocateUseSet (vtkIdType size);


// Did not wrap:  void AllocateVertices (vtkIdType size);


// Did not wrap:  void SavePixelListFrame ();


// Did not wrap:  vtkUnstructuredGridVolumeZSweepMapper (const vtkUnstructuredGridVolumeZSweepMapper &);


// Did not wrap:  void vtkUnstructuredGridVolumeZSweepMapper 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkUnstructuredGridVolumeZSweepMapper(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkUnstructuredGridVolumeZSweepMapper(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkUnstructuredGridVolumeZSweepMapper();
