...
public ref class vtkInformationIntegerVectorKey : public vtkInformationKey
{
...
// Did not wrap:  vtkInformationIntegerVectorKey (const char *name, const char *location, int length);


// Did not wrap:  ~vtkInformationIntegerVectorKey ();
...
// Did not wrap:  vtkInformationIntegerVectorKey (const vtkInformationIntegerVectorKey &);


// Did not wrap:  void vtkInformationIntegerVectorKey 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkInformationIntegerVectorKey(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkInformationIntegerVectorKey(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkInformationIntegerVectorKey();
