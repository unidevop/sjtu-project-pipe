...
public ref class vtkHexagonalPrism : public vtkCell3D
{

public:
// Did not wrap:  static vtkHexagonalPrism *New ();
  ...
  // vtkHexagonalPrism *NewInstance ();
  vtkHexagonalPrism^ NewInstance();


  // vtkHexagonalPrism *SafeDownCast (vtkObject* o);
  static vtkHexagonalPrism^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  void JacobianInverse (double pcoords[3], double *inverse, double derivs[36]);


// Did not wrap:  vtkHexagonalPrism ();


// Did not wrap:  ~vtkHexagonalPrism ();


// Did not wrap:  vtkHexagonalPrism (const vtkHexagonalPrism &);


// Did not wrap:  void vtkHexagonalPrism 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkHexagonalPrism(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkHexagonalPrism(bool donothing);
