...
public ref class vtkInformationUnsignedLongKey : public vtkInformationKey
{
...
// Did not wrap:  vtkInformationUnsignedLongKey (const char *name, const char *location);


// Did not wrap:  ~vtkInformationUnsignedLongKey ();
...
/// </summary>
  void Set(vtkInformation^ info, unsigned long arg1);
...
// Did not wrap:  unsigned long *GetWatchAddress (vtkInformation *info);


// Did not wrap:  vtkInformationUnsignedLongKey (const vtkInformationUnsignedLongKey &);


// Did not wrap:  void vtkInformationUnsignedLongKey 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkInformationUnsignedLongKey(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkInformationUnsignedLongKey(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkInformationUnsignedLongKey();
