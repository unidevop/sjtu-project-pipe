...
public ref class vtkQuadraticPyramid : public vtkNonLinearCell
{

public:
// Did not wrap:  static vtkQuadraticPyramid *New ();
  ...
  // vtkQuadraticPyramid *NewInstance ();
  vtkQuadraticPyramid^ NewInstance();


  // vtkQuadraticPyramid *SafeDownCast (vtkObject* o);
  static vtkQuadraticPyramid^ SafeDownCast(vtkObject^ o);
...
/// </summary>
  void Clip(double value, vtkDataArray^ cellScalars, vtkPointLocator^ locator, vtkCellArray^ tets, vtkPointData^ inPd, vtkPointData^ outPd, vtkCellData^ inCd, int cellId, vtkCellData^ outCd, int insideOut);
...
// Did not wrap:  void JacobianInverse (double pcoords[3], double *inverse, double derivs[39]);


// Did not wrap:  vtkQuadraticPyramid ();
...
// Did not wrap:  vtkQuadraticPyramid (const vtkQuadraticPyramid &);


// Did not wrap:  void vtkQuadraticPyramid 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkQuadraticPyramid(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkQuadraticPyramid(bool donothing);
