...
public ref class vtkSphericalTransform : public vtkWarpTransform
{

public:
// Did not wrap:  static vtkSphericalTransform *New ();
  ...
  // vtkSphericalTransform *NewInstance ();
  vtkSphericalTransform^ NewInstance();


  // vtkSphericalTransform *SafeDownCast (vtkObject* o);
  static vtkSphericalTransform^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkSphericalTransform ();
...
// Did not wrap:  vtkSphericalTransform (const vtkSphericalTransform &);


// Did not wrap:  void vtkSphericalTransform 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkSphericalTransform(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkSphericalTransform(bool donothing);
