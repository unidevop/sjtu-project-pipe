...
public ref class vtkParametricKlein : public vtkParametricFunction
{
...
public:
  ...
  // vtkParametricKlein *NewInstance ();
  vtkParametricKlein^ NewInstance();


  // vtkParametricKlein *SafeDownCast (vtkObject* o);
  static vtkParametricKlein^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  static vtkParametricKlein *New ();
...
// Did not wrap:  vtkParametricKlein ();


// Did not wrap:  ~vtkParametricKlein ();


// Did not wrap:  vtkParametricKlein (const vtkParametricKlein &);


// Did not wrap:  void vtkParametricKlein 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkParametricKlein(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkParametricKlein(bool donothing);
