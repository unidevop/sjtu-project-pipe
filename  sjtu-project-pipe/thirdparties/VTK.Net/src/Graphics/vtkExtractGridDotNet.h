...
public ref class vtkExtractGrid : public vtkStructuredGridAlgorithm
{

public:
// Did not wrap:  static vtkExtractGrid *New ();
  ...
  // vtkExtractGrid *NewInstance ();
  vtkExtractGrid^ NewInstance();


  // vtkExtractGrid *SafeDownCast (vtkObject* o);
  static vtkExtractGrid^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkExtractGrid (const vtkExtractGrid &);


// Did not wrap:  void vtkExtractGrid 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkExtractGrid(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkExtractGrid(bool donothing);
