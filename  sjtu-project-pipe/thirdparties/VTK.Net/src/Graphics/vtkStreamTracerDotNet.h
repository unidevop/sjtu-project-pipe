...
public ref class vtkStreamTracer : public vtkPolyDataAlgorithm
{
...
// Did not wrap:  static vtkStreamTracer *New ();
...
// Did not wrap:  void CalculateVorticity (vtkGenericCell *cell, double pcoords[3], vtkDoubleArray *cellVectors, double vorticity[3]);


// Did not wrap:  void Integrate (vtkDataSet *input, vtkPolyData *output, vtkDataArray *seedSource, vtkIdList *seedIds, vtkIntArray *integrationDirections, double lastPoint[3], vtkInterpolatedVelocityField *func, int maxCellSize, const char *vecFieldName);


// Did not wrap:  void SimpleIntegrate (double seed[3], double lastPoint[3], double delt, vtkInterpolatedVelocityField *func);


// Did not wrap:  int CheckInputs (vtkInterpolatedVelocityField &func, int *maxCellSize, vtkInformationVector *inputVector);


// Did not wrap:  void GenerateNormals (vtkPolyData *output, double *firstNormal, const char *vecName);


// Did not wrap:  void InitializeSeeds (vtkDataArray &seeds, vtkIdList &seedIds, vtkIntArray &integrationDirections, vtkDataSet *source);


// Did not wrap:  vtkStreamTracer (const vtkStreamTracer &);


// Did not wrap:  void vtkStreamTracer 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkStreamTracer(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkStreamTracer(bool donothing);
