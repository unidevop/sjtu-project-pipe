...
public ref class vtkMultiBlockPLOT3DReader : public vtkHierarchicalDataSetAlgorithm
{

public:
// Did not wrap:  static vtkMultiBlockPLOT3DReader *New ();
  ...
  // vtkMultiBlockPLOT3DReader *NewInstance ();
  vtkMultiBlockPLOT3DReader^ NewInstance();


  // vtkMultiBlockPLOT3DReader *SafeDownCast (vtkObject* o);
...
// Did not wrap:  vtkMultiBlockPLOT3DReader ();
...
// Did not wrap:  int GetNumberOfBlocksInternal (FILE *xyzFp, int verify);
...
// Did not wrap:  vtkMultiBlockPLOT3DReader (const vtkMultiBlockPLOT3DReader &);


// Did not wrap:  void vtkMultiBlockPLOT3DReader 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkMultiBlockPLOT3DReader(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkMultiBlockPLOT3DReader(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkMultiBlockPLOT3DReader();
