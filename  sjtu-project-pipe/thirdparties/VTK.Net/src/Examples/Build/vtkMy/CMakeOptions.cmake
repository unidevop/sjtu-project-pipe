...
IF (VTK_WRAP_DOTNET)
  ...
  OPTION(VTKMY_WRAP_DOTNET
         "Wrap classes into the .NET language."
         ON)

  IF (VTKMY_WRAP_DOTNET)
    INCLUDE(${VTK_CMAKE_DIR}/vtkWrapDotNet.cmake)
    IF (WIN32)
      IF (NOT BUILD_SHARED_LIBS)
        MESSAGE(FATAL_ERROR "DotNet support requires BUILD_SHARED_LIBS to be ON.")
        SET (VTKMY_CAN_BUILD 0)
      ENDIF (NOT BUILD_SHARED_LIBS)
    ENDIF (WIN32)
  ENDIF (VTKMY_WRAP_DOTNET)

ELSE (VTK_WRAP_DOTNET)

  IF (VTKMY_WRAP_DOTNET)
    MESSAGE("Warning. VTKMY_WRAP_DOTNET is ON but the VTK version you have "
            "chosen has not support for DotNet (VTK_WRAP_DOTNET is OFF).  "
            "Please set VTKMY_WRAP_DOTNET to OFF.")
    SET (VTKMY_WRAP_DOTNET OFF)
  ENDIF (VTKMY_WRAP_DOTNET)

ENDIF (VTK_WRAP_DOTNET)
