...
namespace vtk {
  ...
  public:
    ...
    void FireMouseDown( System::Windows::Forms::MouseEventArgs^ ea );
    void FireMouseUp( System::Windows::Forms::MouseEventArgs^ ea );
    void FireMouseMove( System::Windows::Forms::MouseEventArgs^ ea );
    void FireMouseWheel( System::Windows::Forms::MouseEventArgs^ ea );
    void FireKeyPress( System::Windows::Forms::KeyPressEventArgs^ ea );
