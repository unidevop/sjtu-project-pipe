...
namespace vtk
  ...
  void vtkFormsWindowControl::FireMouseDown( System::Windows::Forms::MouseEventArgs^ ea )
    {
  ...
  void vtkFormsWindowControl::FireMouseUp( System::Windows::Forms::MouseEventArgs^ ea )
    {
    unsigned int nFlags = 0;
    if ( (this->ModifierKeys & Keys::Control) == Keys::Control )
      nFlags |= MK_CONTROL;
  ...
  void vtkFormsWindowControl::FireMouseMove( System::Windows::Forms::MouseEventArgs^ ea )
    {
    unsigned int nFlags = 0;
    if ( (this->ModifierKeys & Keys::Control) == Keys::Control )
      nFlags |= MK_CONTROL;
  ...
  void vtkFormsWindowControl::FireKeyPress( System::Windows::Forms::KeyPressEventArgs^ ea )
    {
    unsigned int nFlags = 0;
    if ( (this->ModifierKeys & Keys::Control) == Keys::Control )
      nFlags |= MK_CONTROL;
  ...
  void vtkFormsWindowControl::FireKeyDown( System::Windows::Forms::KeyEventArgs^ ea )
    {
    unsigned int nFlags = 0;
  ...
  void vtkFormsWindowControl::FireKeyUp( System::Windows::Forms::KeyEventArgs^ ea )
    {
    unsigned int nFlags = 0;
    if ( (ea->Modifiers & Keys::Control) == Keys::Control )
      nFlags |= MK_CONTROL;
