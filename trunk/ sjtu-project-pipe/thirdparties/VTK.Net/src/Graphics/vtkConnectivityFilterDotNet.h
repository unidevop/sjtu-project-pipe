...
public ref class vtkConnectivityFilter : public vtkUnstructuredGridAlgorithm
{
...
public:
  ...
  // vtkConnectivityFilter *NewInstance ();
  vtkConnectivityFilter^ NewInstance();


  // vtkConnectivityFilter *SafeDownCast (vtkObject* o);
  static vtkConnectivityFilter^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  static vtkConnectivityFilter *New ();
...
// Did not wrap:  vtkConnectivityFilter ();
...
// Did not wrap:  void TraverseAndMark (vtkDataSet *input);


// Did not wrap:  vtkConnectivityFilter (const vtkConnectivityFilter &);


// Did not wrap:  void vtkConnectivityFilter 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkConnectivityFilter(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkConnectivityFilter(bool donothing);
