...
public ref class vtkExtractUnstructuredGrid : public vtkUnstructuredGridAlgorithm
{
...
public:
  ...
  // vtkExtractUnstructuredGrid *NewInstance ();
  vtkExtractUnstructuredGrid^ NewInstance();


  // vtkExtractUnstructuredGrid *SafeDownCast (vtkObject* o);
  static vtkExtractUnstructuredGrid^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  static vtkExtractUnstructuredGrid *New ();
...
// Did not wrap:  vtkExtractUnstructuredGrid ();
...
// Did not wrap:  vtkExtractUnstructuredGrid (const vtkExtractUnstructuredGrid &);


// Did not wrap:  void vtkExtractUnstructuredGrid 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkExtractUnstructuredGrid(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkExtractUnstructuredGrid(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkExtractUnstructuredGrid();
