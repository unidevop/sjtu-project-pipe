...
public ref class vtkPiecewiseFunctionAlgorithm : public vtkAlgorithm
{

public:
// Did not wrap:  static vtkPiecewiseFunctionAlgorithm *New ();
  ...
  // vtkPiecewiseFunctionAlgorithm *NewInstance ();
  vtkPiecewiseFunctionAlgorithm^ NewInstance();


  // vtkPiecewiseFunctionAlgorithm *SafeDownCast (vtkObject* o);
  static vtkPiecewiseFunctionAlgorithm^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkPiecewiseFunctionAlgorithm ();
...
// Did not wrap:  vtkPiecewiseFunctionAlgorithm (const vtkPiecewiseFunctionAlgorithm &);


// Did not wrap:  void vtkPiecewiseFunctionAlgorithm 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkPiecewiseFunctionAlgorithm(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkPiecewiseFunctionAlgorithm(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkPiecewiseFunctionAlgorithm();
