...
public ref class vtkInformationIdTypeKey : public vtkInformationKey
{
...
// Did not wrap:  vtkInformationIdTypeKey (const char *name, const char *location);


// Did not wrap:  ~vtkInformationIdTypeKey ();
...
// Did not wrap:  vtkIdType *GetWatchAddress (vtkInformation *info);


// Did not wrap:  vtkInformationIdTypeKey (const vtkInformationIdTypeKey &);


// Did not wrap:  void vtkInformationIdTypeKey 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkInformationIdTypeKey(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkInformationIdTypeKey(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkInformationIdTypeKey();
