...
public ref class vtkGenericDataSetAlgorithm : public vtkAlgorithm
{
...
public:
  ...
  // vtkGenericDataSetAlgorithm *NewInstance ();
  vtkGenericDataSetAlgorithm^ NewInstance();
...
// Did not wrap:  vtkGenericDataSetAlgorithm ();
...
// Did not wrap:  virtual int RequestDataObject (vtkInformation *request, vtkInformationVector *inputVector, vtkInformationVector *outputVector) = 0;
...
// Did not wrap:  vtkGenericDataSetAlgorithm (const vtkGenericDataSetAlgorithm &);


// Did not wrap:  void vtkGenericDataSetAlgorithm 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkGenericDataSetAlgorithm(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkGenericDataSetAlgorithm(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkGenericDataSetAlgorithm();
