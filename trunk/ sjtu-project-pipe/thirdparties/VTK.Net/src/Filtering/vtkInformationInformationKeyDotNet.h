...
public ref class vtkInformationInformationKey : public vtkInformationKey
{
...
// Did not wrap:  vtkInformationInformationKey (const char *name, const char *location);


// Did not wrap:  ~vtkInformationInformationKey ();
...
// Did not wrap:  vtkInformationInformationKey (const vtkInformationInformationKey &);


// Did not wrap:  void vtkInformationInformationKey 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkInformationInformationKey(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkInformationInformationKey(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkInformationInformationKey();
