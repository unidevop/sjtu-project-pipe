...
public ref class vtkImageAnisotropicDiffusion2D : public vtkImageSpatialAlgorithm
{

public:
// Did not wrap:  static vtkImageAnisotropicDiffusion2D *New ();
  ...
  static vtkImageAnisotropicDiffusion2D^ SafeDownCast(vtkObject^ o);
...
// Did not wrap:  vtkImageAnisotropicDiffusion2D ();
...
// Did not wrap:  void Iterate (vtkImageData *in, vtkImageData *out, double ar0, double ar1, int *coreExtent, int count);


// Did not wrap:  vtkImageAnisotropicDiffusion2D (const vtkImageAnisotropicDiffusion2D &);


// Did not wrap:  void vtkImageAnisotropicDiffusion2D 


  /// <summary>
  /// This constructor is used to convert native pointers into managed wrapper classes.
  /// </summary>
  vtkImageAnisotropicDiffusion2D(System::IntPtr native, bool bConst);

  /// <summary>
  /// This constructor is called only by derived classes. It asks base classes not allocate a native instance.
  /// </summary>
  vtkImageAnisotropicDiffusion2D(bool donothing);
  ...
  /// </remarks>
  virtual ~vtkImageAnisotropicDiffusion2D();
