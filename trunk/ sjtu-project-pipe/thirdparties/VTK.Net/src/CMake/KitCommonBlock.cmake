...
# if we are wrapping into DotNet then add the library and extra
# source files
#
IF (VTK_WRAP_DOTNET)
  INCLUDE(${VTK_SOURCE_DIR}/CMake/KitCommonDotNetWrapBlock.cmake)
...
IF(LOCALUSERMACRODEFINED)
  LocalUserOptionsMacro( "${Kit_SRCS}"       "${Kit_EXTRA_SRCS}"
                         ...
                         "${KitDotNet_SRCS}"   "${Kit_DOTNET_EXTRA_SRCS}")
