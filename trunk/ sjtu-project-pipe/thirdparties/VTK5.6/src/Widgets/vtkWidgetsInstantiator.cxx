...
extern vtkObject* vtkInstantiatorvtkAffineRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkAffineWidgetNew();
extern vtkObject* vtkInstantiatorvtkAngleRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkAngleRepresentation3DNew();
extern vtkObject* vtkInstantiatorvtkAngleWidgetNew();
extern vtkObject* vtkInstantiatorvtkBalloonRepresentationNew();
extern vtkObject* vtkInstantiatorvtkBalloonWidgetNew();
extern vtkObject* vtkInstantiatorvtkBezierContourLineInterpolatorNew();
extern vtkObject* vtkInstantiatorvtkBiDimensionalRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkBiDimensionalWidgetNew();
extern vtkObject* vtkInstantiatorvtkBorderRepresentationNew();
extern vtkObject* vtkInstantiatorvtkBorderWidgetNew();
extern vtkObject* vtkInstantiatorvtkBoundedPlanePointPlacerNew();
extern vtkObject* vtkInstantiatorvtkBoxRepresentationNew();
extern vtkObject* vtkInstantiatorvtkBoxWidgetNew();
extern vtkObject* vtkInstantiatorvtkBoxWidget2New();
extern vtkObject* vtkInstantiatorvtkCameraRepresentationNew();
extern vtkObject* vtkInstantiatorvtkCameraWidgetNew();
extern vtkObject* vtkInstantiatorvtkCaptionRepresentationNew();
extern vtkObject* vtkInstantiatorvtkCaptionWidgetNew();
extern vtkObject* vtkInstantiatorvtkCenteredSliderRepresentationNew();
extern vtkObject* vtkInstantiatorvtkCenteredSliderWidgetNew();
extern vtkObject* vtkInstantiatorvtkContourWidgetNew();
extern vtkObject* vtkInstantiatorvtkCheckerboardRepresentationNew();
extern vtkObject* vtkInstantiatorvtkCheckerboardWidgetNew();
extern vtkObject* vtkInstantiatorvtkConstrainedPointHandleRepresentationNew();
extern vtkObject* vtkInstantiatorvtkDijkstraImageContourLineInterpolatorNew();
extern vtkObject* vtkInstantiatorvtkDistanceWidgetNew();
extern vtkObject* vtkInstantiatorvtkDistanceRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkEllipsoidTensorProbeRepresentationNew();
extern vtkObject* vtkInstantiatorvtkEventNew();
extern vtkObject* vtkInstantiatorvtkFocalPlanePointPlacerNew();
extern vtkObject* vtkInstantiatorvtkHandleWidgetNew();
extern vtkObject* vtkInstantiatorvtkHoverWidgetNew();
extern vtkObject* vtkInstantiatorvtkImageActorPointPlacerNew();
extern vtkObject* vtkInstantiatorvtkImageOrthoPlanesNew();
extern vtkObject* vtkInstantiatorvtkImagePlaneWidgetNew();
extern vtkObject* vtkInstantiatorvtkImageTracerWidgetNew();
extern vtkObject* vtkInstantiatorvtkImplicitPlaneRepresentationNew();
extern vtkObject* vtkInstantiatorvtkImplicitPlaneWidgetNew();
extern vtkObject* vtkInstantiatorvtkImplicitPlaneWidget2New();
extern vtkObject* vtkInstantiatorvtkLinearContourLineInterpolatorNew();
extern vtkObject* vtkInstantiatorvtkLineRepresentationNew();
extern vtkObject* vtkInstantiatorvtkLineWidgetNew();
extern vtkObject* vtkInstantiatorvtkLineWidget2New();
extern vtkObject* vtkInstantiatorvtkLogoRepresentationNew();
extern vtkObject* vtkInstantiatorvtkLogoWidgetNew();
extern vtkObject* vtkInstantiatorvtkOrientationMarkerWidgetNew();
extern vtkObject* vtkInstantiatorvtkOrientedGlyphContourRepresentationNew();
extern vtkObject* vtkInstantiatorvtkOrientedGlyphFocalPlaneContourRepresentationNew();
extern vtkObject* vtkInstantiatorvtkParallelopipedRepresentationNew();
extern vtkObject* vtkInstantiatorvtkParallelopipedWidgetNew();
extern vtkObject* vtkInstantiatorvtkClosedSurfacePointPlacerNew();
extern vtkObject* vtkInstantiatorvtkPlaneWidgetNew();
extern vtkObject* vtkInstantiatorvtkPlaybackRepresentationNew();
extern vtkObject* vtkInstantiatorvtkPlaybackWidgetNew();
extern vtkObject* vtkInstantiatorvtkPointHandleRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkPointHandleRepresentation3DNew();
extern vtkObject* vtkInstantiatorvtkPointPlacerNew();
extern vtkObject* vtkInstantiatorvtkPointWidgetNew();
extern vtkObject* vtkInstantiatorvtkPolyDataPointPlacerNew();
extern vtkObject* vtkInstantiatorvtkPolygonalHandleRepresentation3DNew();
extern vtkObject* vtkInstantiatorvtkOrientedPolygonalHandleRepresentation3DNew();
extern vtkObject* vtkInstantiatorvtkPolygonalSurfacePointPlacerNew();
extern vtkObject* vtkInstantiatorvtkPolygonalSurfaceContourLineInterpolatorNew();
extern vtkObject* vtkInstantiatorvtkRectilinearWipeRepresentationNew();
extern vtkObject* vtkInstantiatorvtkRectilinearWipeWidgetNew();
extern vtkObject* vtkInstantiatorvtkScalarBarRepresentationNew();
extern vtkObject* vtkInstantiatorvtkScalarBarWidgetNew();
extern vtkObject* vtkInstantiatorvtkSeedRepresentationNew();
extern vtkObject* vtkInstantiatorvtkSeedWidgetNew();
extern vtkObject* vtkInstantiatorvtkSliderRepresentation2DNew();
extern vtkObject* vtkInstantiatorvtkSliderRepresentation3DNew();
extern vtkObject* vtkInstantiatorvtkSliderWidgetNew();
extern vtkObject* vtkInstantiatorvtkSphereHandleRepresentationNew();
extern vtkObject* vtkInstantiatorvtkSphereRepresentationNew();
extern vtkObject* vtkInstantiatorvtkSphereWidgetNew();
extern vtkObject* vtkInstantiatorvtkSphereWidget2New();
extern vtkObject* vtkInstantiatorvtkSplineRepresentationNew();
extern vtkObject* vtkInstantiatorvtkSplineWidgetNew();
extern vtkObject* vtkInstantiatorvtkSplineWidget2New();
extern vtkObject* vtkInstantiatorvtkTensorProbeWidgetNew();
extern vtkObject* vtkInstantiatorvtkTerrainDataPointPlacerNew();
extern vtkObject* vtkInstantiatorvtkTerrainContourLineInterpolatorNew();
extern vtkObject* vtkInstantiatorvtkTextRepresentationNew();
extern vtkObject* vtkInstantiatorvtkTextWidgetNew();
extern vtkObject* vtkInstantiatorvtkWidgetCallbackMapperNew();
extern vtkObject* vtkInstantiatorvtkWidgetEventNew();
extern vtkObject* vtkInstantiatorvtkWidgetEventTranslatorNew();
extern vtkObject* vtkInstantiatorvtkWidgetSetNew();
