...
extern vtkObject* vtkInstantiatorvtkPExodusIIReaderNew();
extern vtkObject* vtkInstantiatorvtkPExodusReaderNew();
extern vtkObject* vtkInstantiatorvtkWin32VideoSourceNew();
...
void vtkHybridInstantiator::ClassInitialize()
{
  ...
  vtkInstantiator::RegisterInstantiator("vtkPExodusIIReader", vtkInstantiatorvtkPExodusIIReaderNew);
  vtkInstantiator::RegisterInstantiator("vtkPExodusReader", vtkInstantiatorvtkPExodusReaderNew);
...
{ 
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkPExodusIIReader", vtkInstantiatorvtkPExodusIIReaderNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPExodusReader", vtkInstantiatorvtkPExodusReaderNew);
