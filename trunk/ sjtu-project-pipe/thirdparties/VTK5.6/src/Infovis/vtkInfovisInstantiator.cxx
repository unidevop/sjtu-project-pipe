...
extern vtkObject* vtkInstantiatorvtkPBivariateLinearTableThresholdNew();
extern vtkObject* vtkInstantiatorvtkPCorrelativeStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPContingencyStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPDescriptiveStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPKMeansStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPMultiCorrelativeStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPPCAStatisticsNew();
extern vtkObject* vtkInstantiatorvtkPComputeHistogram2DOutliersNew();
extern vtkObject* vtkInstantiatorvtkPExtractHistogram2DNew();
extern vtkObject* vtkInstantiatorvtkPPairwiseExtractHistogram2DNew();
...
void vtkInfovisInstantiator::ClassInitialize()
{
  ...
  vtkInstantiator::RegisterInstantiator("vtkPBivariateLinearTableThreshold", vtkInstantiatorvtkPBivariateLinearTableThresholdNew);
  vtkInstantiator::RegisterInstantiator("vtkPCorrelativeStatistics", vtkInstantiatorvtkPCorrelativeStatisticsNew);
  vtkInstantiator::RegisterInstantiator("vtkPContingencyStatistics", vtkInstantiatorvtkPContingencyStatisticsNew);
  vtkInstantiator::RegisterInstantiator("vtkPDescriptiveStatistics", vtkInstantiatorvtkPDescriptiveStatisticsNew);
  vtkInstantiator::RegisterInstantiator("vtkPKMeansStatistics", vtkInstantiatorvtkPKMeansStatisticsNew);
  vtkInstantiator::RegisterInstantiator("vtkPMultiCorrelativeStatistics", vtkInstantiatorvtkPMultiCorrelativeStatisticsNew);
  vtkInstantiator::RegisterInstantiator("vtkPPCAStatistics", vtkInstantiatorvtkPPCAStatisticsNew);
...
{ 
  ...
  vtkInstantiator::UnRegisterInstantiator("vtkPBivariateLinearTableThreshold", vtkInstantiatorvtkPBivariateLinearTableThresholdNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPCorrelativeStatistics", vtkInstantiatorvtkPCorrelativeStatisticsNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPContingencyStatistics", vtkInstantiatorvtkPContingencyStatisticsNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPDescriptiveStatistics", vtkInstantiatorvtkPDescriptiveStatisticsNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPKMeansStatistics", vtkInstantiatorvtkPKMeansStatisticsNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPMultiCorrelativeStatistics", vtkInstantiatorvtkPMultiCorrelativeStatisticsNew);
  vtkInstantiator::UnRegisterInstantiator("vtkPPCAStatistics", vtkInstantiatorvtkPPCAStatisticsNew);
